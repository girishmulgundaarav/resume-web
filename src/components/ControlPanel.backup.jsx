...
import { Printer, Moon, Sun, Upload, RotateCcw, Sparkles } from 'lucide-react';
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="font-bold text-lg leading-tight tracking-tight flex items-center gap-2">
              ...
              <span className="bg-amber-400 bg-opacity-25 text-amber-300 text-xs px-2 py-0.5 rounded-full font-normal border border-amber-400 border-opacity-35">
                Tailwind CSS
              </span>
            </h1>
            <p className="text-slate-400 text-xs">Click any text block below to edit inline. Changes auto-save.</p>
          </div>
        </div>
